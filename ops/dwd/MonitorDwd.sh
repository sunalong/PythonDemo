...
#python /data/soft/data_quality_check/main/main.py "$@"
#python ${curr_dir}/MonitorDwd.py --method insertToMysql --current_table dwd_order_db__t_trade_order_item
#python ${curr_dir}/MonitorDwd.py --method ${method} --current_table $2
